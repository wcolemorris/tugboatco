...
export async function GET() {
  try {
    ...
    const base = `
    A single tugboat, starboard side visible, with the text "sponsors@tugboat.co" painted on the side, moves steadily from left to right across calm ocean water.
